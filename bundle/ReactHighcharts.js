...
})(this, function(__WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_16__) {
...
module.exports = function (chartType, Highcharts) {
  ...
  var result = createReactClass({
    ...
    shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
      ...
      if (this.props.config.series !== nextProps.config.series) {
        //fakes a "react" render as more data is loaded
        this.props.config.series.map(function (oldSeries, index) {
          if (oldSeries !== nextProps.config.series[index]) {
            _this.chart.series[index].setData(nextProps.config.series, false);
          }
        });
        this.chart.redraw();
        return false;
...
module.exports = __webpack_require__(10)('Chart', __webpack_require__(16));
